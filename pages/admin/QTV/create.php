...
if (!empty($_POST)) {
    ...
    if (empty($values['ma_sinh_vien'])) {
        $errors['ma_sinh_vien'] = 'Mã Quản trị viên là bắt buộc';
    }
    if (empty($values['ho'])) {
        ...
        if (!$stmt->execute()) {
            ...
            if (!empty($error)) {
                ...
                if (endsWith($error, "'ma_sinh_vien_UNIQUE'")) {
                    $message = array('type' => 'error', 'message' => 'Mã Quản Trị viên đẫ được dùng đã được sử dụng!');
                    $errors['ma_sinh_vien'] = 'Mã Quản Trị viên đẫ được dùng đã được sử dụng!';
                }
                $db->rollback();
            } else {
                    ...
                    <div class="column is-9">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-header-title">Thêm Quản Trị Viên</div>
                            </div>
                            <div class="card-content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php print path('/index.php?p=admin/QTV/create'); ?>">
                                    <div class="field">
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <button type="submit" class="button is-link">Thêm Quản Trị Viên</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
